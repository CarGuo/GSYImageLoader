...
```
     ...
     */
    fun isCache(loadOption: GSYLoadOption, extendOption: IGSYImageLoader.ExtendedOptions? = null): Boolean
     ...
     * @return File
     */
    fun getLocalCache(loadOption: GSYLoadOption, extendOption: IGSYImageLoader.ExtendedOptions? = null): File?
     ...
     * @return Bitmap
     */
    fun getLocalCacheBitmap(loadOption: GSYLoadOption, extendOption: IGSYImageLoader.ExtendedOptions? = null): Bitmap?
     ...
     * @return Bitmap
     */
    fun downloadOnly(loadOption: GSYLoadOption, callback: IGSYImageLoader.Callback?, extendOption: IGSYImageLoader.ExtendedOptions? = null)
